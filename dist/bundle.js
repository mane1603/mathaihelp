...
(() => {
  ...
  var e = {
      ...
      551: (e, n, t) => {
        ...
        function cs(e) {
          ...
          try {
            ...
            (wn = r), (Ni.transition = t), !(6 & (Pi = n)) && Vl();
          }
        }
        function fs() {
          (Ri = Mi.current), _l(Mi);
      ...
      964: (e, n, t) => {
        e.exports = t.p + "7768efe3e7e12832ddbd.png";
      },
    },
    n = {};
  function t(r) {
  ...
  const w = function () {
    return (0, r.jsx)("button", {
      onClick: function () {
        ...
        (n.className = "selection-box"), document.body.appendChild(n);
        var t = 0,
          r = 0,
          l = !1,
          a = function (e) {
          ...
          o = function (e) {
            if (l) {
              var a = e.pageX,
                ...
                u = a - t,
                i = o - r;
              (n.style.width = "".concat(Math.abs(u), "px")),
                (n.style.height = "".concat(Math.abs(i), "px")),
                (n.style.left = "".concat(u < 0 ? a : t, "px")),
                (n.style.top = "".concat(i < 0 ? o : r, "px"));
            }
          },
          u = function () {
            (l = !1),
        ...
        chrome.tabs.captureVisibleTab({ format: "png" }, function (n) {
          var t = new Image();
          (t.src = n),
            (t.onload = function () {
              ...
              (i.href = l), (i.download = "screenshot.png"), i.click();
            });
        });
      },
      id: "captureButton",
  ...
  const k = function () {
    ...
    return (
        ...
        (e = void 0),
          ...
          (l = function () {
            ...
            return (function (e, n) {
                        ...
                        switch (
                          ...
                          default:
                            if (
                              !(
                                (l =
                                  (l = a.trys).length > 0 && l[l.length - 1]) ||
                                (6 !== u[0] && 2 !== u[0])
                              )
                            ) {
                              a = 0;
                            ...
                            if (6 === u[0] && a.label < l[1]) {
                              (a.label = l[1]), (l = u);
                              break;
                            }
                            if (l && a.label < l[2]) {
                              (a.label = l[2]), a.ops.push(u);
                              break;
                            }
              ...
              switch (n.label) {
                case 0:
                  return [4, chrome.storage.local.get("result")];
                case 1:
                  return (e = n.sent()), t(e.result), u(e.message), [2];
              }
            });
          }),
      ...
      (0, r.jsxs)("div", {
        ...
        children: [
          o && (0, r.jsx)("p", { children: o }),
          n
            ? (0, r.jsx)("img", { src: n, alt: "Screenshot result" })
            : (0, r.jsx)("p", { children: "No result to display." }),
        ],
      })
    );
  };
  var S = function () {
    ...
    return (
      ...
      (0, r.jsx)(r.Fragment, {
        children: n
          ? (0, r.jsx)("button", { className: "login", children: "Sing in" })
          : (0, r.jsx)("button", {
              children: (0, r.jsx)("img", {
                src: "../../../public/singout.png",
                alt: "sing out",
              }),
            }),
      })
  ...
  const x = function () {
    return (0, r.jsxs)("div", {
      className: "header",
      children: [
        (0, r.jsx)("img", { src: "../../../public/header_logo.png", alt: "" }),
        (0, r.jsx)(S, {}),
      ],
    });
  };
  ...
  a.createRoot(document.getElementById("math-help-ai__root")).render(
    (0, r.jsx)(l.StrictMode, {
      children: (0, r.jsx)(function () {
        return (0,
        r.jsxs)("div", { className: "app-container", children: [(0, r.jsx)(x, {}), (0, r.jsx)(w, {}), (0, r.jsx)(k, {})] });
      }, {}),
    })
  );
})();
